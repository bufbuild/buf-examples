...
const file_bufbuild_people_v1_person_proto_rawDesc = "" +
	"\n" +
	"\x1fbufbuild/people/v1/person.proto\x12\x12bufbuild.people.v1\x1a\x1bbuf/validate/validate.proto\"\xa3\x01\n" +
	"\x06Person\x12(\n" +
	"\n" +
	"first_name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x182R\tfirstName\x12(\n" +
	"\vmiddle_name\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x182R\n" +
	"middleName\x12&\n" +
	"\tlast_name\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x182R\blastName\x12\x1d\n" +
	"\x05title\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x18@R\x05titleB\xf6\x01\n" +
	"\x16com.bufbuild.people.v1B\vPersonProtoP\x01Zegithub.com/bufbuild/buf-examples/protovalidate/rules-predefined/start/gen/bufbuild/people/v1;peoplev1\xa2\x02\x03BPX\xaa\x02\x12Bufbuild.People.V1\xca\x02\x12Bufbuild\\People\\V1\xe2\x02\x1eBufbuild\\People\\V1\\GPBMetadata\xea\x02\x14Bufbuild::People::V1b\x06proto3"
