...
class GetWeatherRequest(_message.Message):
    ...
    def __init__(self, latitude: _Optional[float] = ..., longitude: _Optional[float] = ..., forecast_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
