 ...
 */
export declare const file_bufbuild_weather_v1_weather_service: GenFile;
 ...
 */
export declare type GetWeatherRequest = Message<"bufbuild.weather.v1.GetWeatherRequest"> & {
  /**
 ...
 */
export declare const GetWeatherRequestSchema: GenMessage<GetWeatherRequest>;
