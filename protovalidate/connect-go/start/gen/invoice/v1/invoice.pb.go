...
const file_invoice_v1_invoice_proto_rawDesc = "" +
	...
	"\n" +
	"unit_price\x18\x04 \x01(\x04R\tunitPriceB\xc1\x01\n" +
	"\x0ecom.invoice.v1B\fInvoiceProtoP\x01ZXgithub.com/bufbuild/buf-examples/protovalidate/connect-go/start/gen/invoice/v1;invoicev1\xa2\x02\x03IXX\xaa\x02\n" +
	"Invoice.V1\xca\x02\n" +
