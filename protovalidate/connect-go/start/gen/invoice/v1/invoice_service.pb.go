...
const file_invoice_v1_invoice_service_proto_rawDesc = "" +
	...
	"\rCreateInvoice\x12 .invoice.v1.CreateInvoiceRequest\x1a!.invoice.v1.CreateInvoiceResponseB\xc8\x01\n" +
	"\x0ecom.invoice.v1B\x13InvoiceServiceProtoP\x01ZXgithub.com/bufbuild/buf-examples/protovalidate/connect-go/start/gen/invoice/v1;invoicev1\xa2\x02\x03IXX\xaa\x02\n" +
	"Invoice.V1\xca\x02\n" +
