...
const file_bufbuild_weather_v1_weather_service_proto_rawDesc = "" +
	"\n" +
	")bufbuild/weather/v1/weather_service.proto\x12\x13bufbuild.weather.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8e\x01\n" +
	"\x11GetWeatherRequest\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x02R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x02R\tlongitude\x12?\n" +
	"\rforecast_date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\fforecastDateB\x82\x02\n" +
	"\x17com.bufbuild.weather.v1B\x13WeatherServiceProtoP\x01Zdgithub.com/bufbuild/buf-examples/protovalidate/quickstart-go/start/gen/bufbuild/weather/v1;weatherv1\xa2\x02\x03BWX\xaa\x02\x13Bufbuild.Weather.V1\xca\x02\x13Bufbuild\\Weather\\V1\xe2\x02\x1fBufbuild\\Weather\\V1\\GPBMetadata\xea\x02\x15Bufbuild::Weather::V1b\x06proto3"
