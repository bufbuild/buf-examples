...
const file_invoice_v1_invoice_proto_rawDesc = "" +
	...
	"\x1bline_item_id.not.product_id\x12'line_item_id can't also be a product_id\x1a$this.line_item_id != this.product_idB\xbe\x01\n" +
	"\x0ecom.invoice.v1B\fInvoiceProtoP\x01ZUgithub.com/bufbuild/buf-examples/bufstream/quickstart/finish/gen/invoice/v1;invoicev1\xa2\x02\x03IXX\xaa\x02\n" +
	"Invoice.V1\xca\x02\n" +
